...
def build():
    ...
    manifest = {'run_id':run,'status':'review candidate; v6 citation smoke evaluated with semantic errors; v7 typed-value live validation pending; no expert legal review',
